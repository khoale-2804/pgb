...
func (c ProductCategoryCol) Match(q string) pgb.Expr {
	return pgb.Match(c.Col, q)
}

func (c ProductCategoryCol) MatchAll(q string) pgb.Expr {
	return pgb.MatchAll(c.Col, q)
}

func (c ProductCategoryCol) Phrase(q string, slop int) pgb.Expr {
	return pgb.Phrase(c.Col, q, slop)
}

func (c ProductCategoryCol) Exact(v any) pgb.Expr {
	return pgb.Exact(c.Col, v)
}

func (c ProductCategoryCol) ExactAny(vs []string) pgb.Expr {
	return pgb.ExactAny(c.Col, vs, "text")
}

func (c ProductCategoryCol) Fuzzy(q string, dist int, prefix bool) pgb.Expr {
	return pgb.Fuzzy(c.Col, q, dist, prefix)
}

func (c ProductCategoryCol) Regex(pattern string) pgb.Expr {
	return pgb.Regex(c.Col, pattern)
}

func (c ProductCategoryCol) Parse(q string) pgb.Expr {
	return pgb.Parse(c.Col, q, false)
}

func (c ProductCategoryCol) MatchB(q string, b float64) pgb.Expr {
	return pgb.Boost(pgb.Match(c.Col, q), b)
}

func (c ProductCategoryCol) Snippet(startTag, endTag string, maxChars int) pgb.Expr {
	return pgb.Snippet(c.Col, startTag, endTag, maxChars)
}

func (c ProductCategoryCol) Snippets(limitN, offsetN int, sortBy string) pgb.Expr {
	return pgb.Snippets(c.Col, limitN, offsetN, sortBy)
}

func (c ProductCategoryCol) Highlight() pgb.Expr {
	return pgb.Highlight(c.Col)
}

// ProductAttributesBrandCol carries the pg_search surface for the indexed JSON path
// (products.attributes->'brand')::pdb.literal('alias=brand') (index alias brand): the path is re-emitted exactly as indexed,
// through pgb.Raw. No Boost composition (MatchB) or snippets on path
// fields.
type ProductAttributesBrandCol struct{ pgb.Col }

func (c ProductAttributesBrandCol) Match(q string) pgb.Expr {
	return pgb.Raw{SQL: "(products.attributes->'brand')::pdb.literal('alias=brand') ||| ?", Args: []any{q}}
}

func (c ProductAttributesBrandCol) MatchAll(q string) pgb.Expr {
	return pgb.Raw{SQL: "(products.attributes->'brand')::pdb.literal('alias=brand') &&& ?", Args: []any{q}}
}

func (c ProductAttributesBrandCol) Exact(v any) pgb.Expr {
	return pgb.Raw{SQL: "(products.attributes->'brand')::pdb.literal('alias=brand') === ?", Args: []any{v}}
}

func (c ProductAttributesBrandCol) ExactAny(vs []string) pgb.Expr {
	return pgb.Raw{SQL: "(products.attributes->'brand')::pdb.literal('alias=brand') === ?::text[]", Args: []any{vs}}
}

func (c ProductAttributesBrandCol) Regex(pattern string) pgb.Expr {
	return pgb.Raw{SQL: "(products.attributes->'brand')::pdb.literal('alias=brand') @@@ pdb.regex(?)", Args: []any{pattern}}
}

func (c ProductAttributesBrandCol) Parse(q string) pgb.Expr {
	return pgb.Raw{SQL: "(products.attributes->'brand')::pdb.literal('alias=brand') @@@ pdb.parse(?)", Args: []any{q}}
}
